...
<hr><p></p><hr>
    ...
    <div class="contenedor">
      ...
      <form onsubmit="return validar()" action="../funciones/actualizarProducto.php" method="get" class="borde sombra" style="padding: 10px">
        <table>
          <tr>
            <td>Id.</td>
            <td>
              <input type="text" id="idProducto" name="idProducto" size="11" value="<?php echo $prod->getIdProducto(); ?>" readonly/>
            </td>
          </tr>
          <tr>
            <td>Descripcion: </td>
            <td>
              <input type="text" id="descripcion" name="descripcion" value="<?php echo $prod->getDescripcion(); ?>" size="50"/>
            </td>
          </tr>
          <tr>
            <td>Inventario: </td>
            <td>
              <input type="text" id="inventario" name="inventario" size="10" value="<?php echo $prod->getInventario(); ?>"/>
            </td>
          </tr>
          <tr>
            <td>Precio: </td>
            <td>
              <input type="text" id="precio" name="precio" size="11" value="<?php echo $prod->getPrecio(); ?>" class="alDer marInt"/>
            </td>
          </tr>
            ...
            <td>
              <select id="id" name="id">
                <?php foreach ($revistaControl->obtenerTodos() as $cat) { ?>
                  <option value="<?php echo $cat->id; ?>" <?php echo ($prod->getId() == $cat->id ? "selected" : "") ?> >
